### This repo contains Airflow setup with custom DAG

**DAG consists of 3 steps: get API NBU data -> create table if it doesn't exist -> insert API NBU data into PostgreSQL.** 
To prepare DAG, used task steps from [this repo](https://github.com/valievav/nbu_currency_exchange_rate/blob/main/task/task_functions.py) (simplified version, adapted from SQLite to Postgres)
